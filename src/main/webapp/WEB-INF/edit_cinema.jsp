    ...
    <div class="card-body p-4">
        <div class="d-flex text-black">
            <div class="flex-grow-1 ms-3" style="font-weight: 600">
                <h1>Edit Cinema</h1>
                <%--@elvariable id="cinema" type=""--%>
                <form:form action="/admin/cinema/edit/${cinema.id}" method="put" modelAttribute="cinema">
                    <div class="h7 pt-1">
                        <form:label path="cinemaName">Cinema Name: </form:label>
                        <form:input path="cinemaName" placeholder="Cinema" value="${cinema.cinemaName}" style="margin-left: 5px"/>
                        <div><form:errors path="cinemaName" class="text-danger"></form:errors></div>
                    </div>

                    <div class="h7 pt-1">
                        <form:label path="latitude">Latitude: </form:label>
                        <form:input path="latitude" type="number" step="0.0000001" placeholder="Latitude" value="${cinema.latitude}" style="margin-left: 47px"/>
                        <div><form:errors path="latitude" class="text-danger"></form:errors></div>
                    </div>

                    <div class="h7 pt-1">
                        <form:label path="longitude">Longitude: </form:label>
                        <form:input path="longitude" type="number" step="0.0000001" placeholder="Longitude" value="${cinema.longitude}" style="margin-left: 33px"/>
                        <div><form:errors path="longitude" class="text-danger"></form:errors></div>
                    </div>

                    <div class="pt-2">
                        <a href="/admin" class="btn btn-outline-dark me-1" style="width: 110px">Cancel</a>
                        <button class="btn btn-dark" style="width: 200px">Edit Cinema</button>
                    </div>
                </form:form>
            </div>
        </div>
